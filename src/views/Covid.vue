<template>
  <v-container>
    ...
    <p>
      To search the information of a country please write the name and press
      enter
    </p>
    ...
    <v-card>
      ...
      >
        <template v-slot:item="{ item }">
          <tr
            :class="selectedRow.indexOf(item.country)"
...
export default {
  ...
  mounted() {
    ...
    mapboxgl.accessToken =
      "pk.eyJ1IjoianVhbmRpYXpuMTIiLCJhIjoiY2t0eDJmeTRvMnBuaDJucDlqc3p0djU5bSJ9.jLvuW19MDDFc8lEnbs1xew";
  ...
  methods: {
    ...
    rowClicked(row) {
      ...
      this.$router.push({
        name: "Country",
        params: { code: row.code, country: row },
      });
    },
  },
